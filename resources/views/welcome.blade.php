...
<section class="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-100 via-white to-green-100 overflow-hidden">
    ...
    <div class="relative z-10 text-center max-w-6xl mx-auto px-4">
        ...
        <div class="mb-8 bounce-in">
            <div class="w-32 h-32 flex items-center justify-center mx-auto mb-6 flag-animation ">
            <img src="{{ asset('asset/useswadeshi-icon.png') }}" alt="Swadeshi Abhiyan Logo" class=" h-auto">
            </div>
        </div>
        ...
        <h2 class="text-2xl md:text-4xl font-semibold text-gray-700 mb-4">
            Mehsana 2025
        </h2>
        <p class="text-lg md:text-xl mb-8 text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Test your knowledge of Indian products and brands. Join 70,000+ participants in celebrating our nation's entrepreneurial spirit through an interactive cultural quiz.
        </p>
        ...
        <!-- QR Code Info -->
        <div class="bg-gradient-to-r from-orange-50 to-green-50 rounded-2xl p-6 max-w-2xl mx-auto border border-orange-200">
            <div class="flex items-center justify-center space-x-4">
                ...
                <div class="text-left">
                    ...
                    <p class="text-sm text-gray-600">Quick registration with QR code scanning</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-gradient-to-br from-orange-50 to-red-50 rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 border border-orange-100">
                ...
                <p class="text-gray-600 text-center mb-6">Quick registration with basic details or social login. Scan QR code for instant access.</p>
